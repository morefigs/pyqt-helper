...
def process_file(argv: List[str]) -> None:
    """
    Take a text file (e.g. main_ui.txt) that contains names of PyQt objects (e.g. spinBox_distance) and generates an
    output file (e.g. main_ui_helper.py) in the same directory that defines a class with helper properties for the PyQt
    object.
    """
    # check args length
    if len(argv) != 2:
    ...
    with output_path.open('w') as f:
        f.write('# This file was autogenerated using pyqt_ui_helper.py, do NOT edit\n\n\n')
